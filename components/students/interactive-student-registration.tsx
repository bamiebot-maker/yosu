...
export function InteractiveStudentRegistration({ windowStatus }: Props) {
  const isOpen = windowStatus ? windowStatus.isOpen : true;
  ...
  return (
    <div className="space-y-10 font-sans pb-16">
      ...
      {/* CASE 2: REGISTRATION IS CLOSED */}
      {!isOpen ? (
        <div className="bg-white p-8 sm:p-16 rounded-3xl border border-stone-200 shadow-xl text-center space-y-8 max-w-3xl mx-auto">
          {/* Large Illustration Icon */}
          <div className="relative w-24 h-24 bg-rose-50 border-2 border-rose-200 text-rose-600 rounded-3xl mx-auto flex items-center justify-center shadow-lg">
          ...
          {/* Opening & Closing Dates Box */}
          {(windowStatus?.opensAt || windowStatus?.closesAt) && (
            <div className="p-5 bg-stone-50 rounded-2xl border border-stone-200 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-md mx-auto text-xs">
              ...
              {windowStatus.closesAt && (
                <div>
                  ...
                  <span className="font-bold text-rose-700 text-sm flex items-center justify-center gap-1 mt-0.5">
          ...
          <div className="pt-4 flex justify-center">
            <Link
              href="/"
              className="px-8 py-3.5 bg-emerald-950 hover:bg-emerald-900 text-white font-bold text-xs rounded-xl shadow-lg transition-all flex items-center gap-2"
            >
